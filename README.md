...
**링크:** [무료 모델](https://openrouter.ai/models/?q=free) | [Qwen3-Coder API](https://openrouter.ai/qwen/qwen3-coder:free/api)
...
**Pro ($19/월):** 에이전트 요청 한도 증가
  ...
  - 사용량은 지역적 요인 및 사용 패턴에 따라 조정될 수 있음
...
**AI Pro ($15/월):** 클라우드 할당량 증가 + 로컬 모델 무제한
